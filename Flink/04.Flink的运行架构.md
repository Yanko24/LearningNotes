...
![](http://yanko.test.upcdn.net/images/processes.jpg)
...
![](http://yanko.test.upcdn.net/images/tasks_slots.jpg)
...
![](http://yanko.test.upcdn.net/images/slot_sharing.jpg)

##### 2. Parallelism（并行度）

![](http://yanko.test.upcdn.net/images/parallel_dataflow.jpg)
...
![](http://yanko.test.upcdn.net/images/tasks_chains.jpg)
...
![](http://yanko.test.upcdn.net/images/graph.png)

#### 3. 提交流程

##### 1. 通用提交流程

![](http://yanko.test.upcdn.net/images/flink-job.jpg)

##### 2. Yarn-cluster提交流程per-job

![](http://yanko.test.upcdn.net/images/flink-yarn-per-job.jpg)
...
<div align=center>
    <font color='red' size=4>关注微信公众号《零基础学大数据》回复【Flink】领取全部PDF</font>
</div>
